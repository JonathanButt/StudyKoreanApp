...
(function () {
  const unit = {
    ...
    vocabulary: [
      { korean: "좋다", english: "to be good, to like (temporary or permanent)", romanization: "johda", tags: ["adjective", "verb"] },
      { korean: "좋아요", english: "It's good/okay/sounds good", romanization: "johayo", tags: ["adjective"] },
      { korean: "좋아하다", english: "to like (permanent liking only)", romanization: "joahada", tags: ["verb"] },
      { korean: "좋아해요", english: "I like (permanent)", romanization: "joahaeyo", tags: ["verb"] },
      ...
      { korean: "바쁘다", english: "to be busy (ㅡ irregular)", romanization: "bappeuda", tags: ["adjective"] },
      { korean: "바빠요", english: "I'm busy", romanization: "bappayo", tags: ["adjective"] },
      { korean: "나쁘다", english: "to be bad (ㅡ irregular)", romanization: "nappeuda", tags: ["adjective"] },
      { korean: "나빠요", english: "It's bad", romanization: "nappayo", tags: ["adjective"] },
      { korean: "슬프다", english: "to be sad (ㅡ irregular: 슬퍼요)", romanization: "seulpeuda", example: "영화가 슬퍼요.", tags: ["adjective", "emotion"] },
      { korean: "슬퍼요", english: "it's sad, I'm sad", romanization: "seulpeoyo", example: "슬퍼요.", tags: ["adjective"] },
      { korean: "행복하다", english: "to be happy", romanization: "haengbokhada", example: "오늘 정말 행복해요.", tags: ["adjective", "emotion"] },
      { korean: "기분이 좋다", english: "to feel good, to be in a good mood", romanization: "gibuni jota", example: "오늘 기분이 좋아요.", tags: ["phrase", "emotion"] },
      { korean: "기분이 나쁘다", english: "to feel bad, to be in a bad mood", romanization: "gibuni nappeuda", example: "왜 기분이 나빠요?", tags: ["phrase", "emotion"] },
      { korean: "아프다", english: "to hurt, to be sick, to be in pain (ㅡ irregular: 아파요)", romanization: "apeuda", example: "머리가 아파요.", tags: ["adjective"] },
      { korean: "아파요", english: "it hurts, I'm sick", romanization: "apayo", example: "배가 아파요.", tags: ["adjective"] },
      { korean: "위험하다", english: "to be dangerous", romanization: "wiheomhada", example: "여기는 위험해요.", tags: ["adjective"] },
      { korean: "아름답다", english: "to be beautiful (ㅂ irregular: 아름다워요)", romanization: "areumdapda", example: "경치가 아름다워요.", tags: ["adjective"] },
