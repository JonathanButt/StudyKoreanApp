...
(function () {
  const unit = {
    ...
    vocabulary: [
      ...
      { korean: "스물", english: "twenty", romanization: "seumul", tags: ["number", "pure-korean"] },
      { korean: "스무", english: "twenty (with counters)", romanization: "seumu", tags: ["number", "pure-korean", "counter"] },
      ...
      { korean: "1인분", english: "one person portion", romanization: "1inbun", tags: ["food"] },
      { korean: "2인분", english: "two person portion", romanization: "2inbun", tags: ["food"] },
      { korean: "사진", english: "photo, picture", romanization: "sajin", example: "사진 한 장이에요.", tags: ["noun"] },
      { korean: "꽃", english: "flower", romanization: "kkot", example: "꽃이 예뻐요.", tags: ["noun"] },
      { korean: "장미", english: "rose", romanization: "jangmi", example: "빨간 장미예요.", tags: ["noun"] },
      { korean: "꽃다발", english: "bouquet of flowers", romanization: "kkotdabal", example: "꽃다발을 샀어요.", tags: ["noun"] },
      { korean: "강아지", english: "puppy, small dog", romanization: "gangaji", example: "강아지 한 마리 있어요.", tags: ["noun", "animal"] },
      { korean: "신발", english: "shoes (general term)", romanization: "sinbal", example: "신발이 예뻐요.", tags: ["noun", "clothing"] },
      { korean: "구두", english: "dress shoes, formal shoes", romanization: "gudu", example: "구두가 비싸요.", tags: ["noun", "clothing"] },
      { korean: "치마", english: "skirt", romanization: "chima", example: "치마가 예뻐요.", tags: ["noun", "clothing"] },
      { korean: "양말", english: "socks", romanization: "yangmal", example: "양말 두 켤레 주세요.", tags: ["noun", "clothing"] },
      { korean: "코트", english: "coat", romanization: "koteu", example: "코트를 입어요.", tags: ["noun", "clothing"] },
      { korean: "드레스", english: "dress", romanization: "deureseu", example: "드레스가 아름다워요.", tags: ["noun", "clothing"] },
